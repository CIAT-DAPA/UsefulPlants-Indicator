...
species_list<-list.files("//dapadfs/Workspace_cluster_9/Aichi13/parameters/occurrences/no_sea", pattern= ".csv$")

species <- "2650133"

uni<-function(species){
data <- read.csv(paste("//dapadfs/Workspace_cluster_9/Aichi13/parameters/occurrences/no_sea/",species,".csv", sep=""),header=T)
